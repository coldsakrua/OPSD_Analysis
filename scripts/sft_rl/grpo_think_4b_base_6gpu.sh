...
#SBATCH --output=log/train/sft_rl/grpo_think_4b_base_6gpu.%j.out
...
# Qwen3-4B-Base full-param GRPO (DAPO). 6-GPU for activation headroom @12k.
...
RUN_NAME=${RUN_NAME:-grpo_think_4b_base_6gpu}
