...
#SBATCH --output=log/train/sft_rl/grpo_think_1p7b_base_4gpu.%j.out
...
# Qwen3-1.7B-Base full-param GRPO (DAPO). Default intended split 2+2 (hybrid colocated).
...
RUN_NAME=${RUN_NAME:-grpo_think_1p7b_base_4gpu}
