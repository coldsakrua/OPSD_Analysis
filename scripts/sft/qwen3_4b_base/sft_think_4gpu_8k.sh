...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4p4b_base_sft_fullparam_8k}
...
if [[ ! -f "${DATASET_PATH}" ]]; then
  ...
  echo "[error] run: sbatch scripts/sft/qwen3_4b_base/preprocess_le12k.sh" >&2
  exit 1
fi
