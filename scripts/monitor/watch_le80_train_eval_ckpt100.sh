#!/bin/bash
# Watch the pending le80 train jobs. When checkpoint-100 is saved,
...
#
# le80 = --low-entropy-ratio 0.8 (bottom-80% student-entropy tokens in loss)
#
# Default targets (submitted 2026-08-21):
#   3301227  1.7B          st_tt  c256 le80  → think
#   3301228  4B            st_tt  c256 le80  → think
#   3301229  4B-Instruct   snt_tnt c256 le80 → nothink
#   3301230  4B-Thinking   st_tt  c256 le80  → think
#   3301231  Olmo-Instruct snt_tnt c256 le80 → sgl nothink
#   3301232  Olmo-Think    st_tt  c256 le80  → sgl think
#
# Usage:
#   nohup bash scripts/monitor/watch_le80_train_eval_ckpt100.sh \
#     > log/monitor/watch_le80_ckpt100_$(date +%Y%m%d_%H%M%S).log 2>&1 &
#
...
if [[ -n "${SPECS_OVERRIDE:-}" ]]; then
  ...
  SPECS=(
    "3301227|qwen3_1.7b|st_tt_clip005_c256_1p7b_le80|st_tt_clip005_c256_1p7b_le80_ckpt100|st_tt_clip005_c256_1p7b_le80|1.7b|think|th"
    "3301228|qwen3_4b|st_tt_clip005_c256_4b_le80|st_tt_clip005_c256_4b_le80_ckpt100|st_tt_clip005_c256_4b_le80|4b|think|th"
    "3301229|qwen3_4b_instruct|snt_tnt_clip005_c256_oti_le80|snt_tnt_clip005_c256_oti_le80_ckpt100|snt_tnt_clip005_c256_oti_le80|4b_instruct|nothink|nt"
    "3301230|qwen3_4b_thinking|st_tt_clip005_c256_4bt_le80|st_tt_clip005_c256_4bt_le80_ckpt100|st_tt_clip005_c256_4bt_le80|qwen3_4b_thinking|think|th"
    "3301231|olmo3_7b_instruct|snt_tnt_clip005_c256_olmo7bi_le80|snt_tnt_clip005_c256_olmo7bi_le80_ckpt100|snt_tnt_clip005_c256_olmo7bi_le80|olmo3_7b_instruct|sgl|sgl"
    "3301232|olmo3_7b_think|st_tt_clip005_c256_olmo7bt_le80|st_tt_clip005_c256_olmo7bt_le80_ckpt100|st_tt_clip005_c256_olmo7bt_le80|olmo_7b_think|sgl|sgl"
  )
fi
...
main() {
  mkdir -p "${BASE_DIR}/log/monitor"
  log "le80 monitor start: ${#SPECS[@]} trains × 4 evals (aime24/25/26+hmmt25), poll=${POLL_SEC}s step=${STEP}"
