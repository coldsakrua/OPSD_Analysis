#!/bin/bash
#SBATCH --job-name=eval_mimo7b_hmmt25_sgl
#SBATCH --output=log/eval/mimo_7b_rl/hmmt25/sgl/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/mimo_7b_rl/hmmt25/sgl"
...
echo "[eval] dataset=${DATASET} (empty system prompt; official temp=0.6 top_p=0.95 max_tokens=32768)"
