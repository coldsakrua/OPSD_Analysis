#!/bin/bash
#SBATCH --job-name=eval_r1_15b_h25
#SBATCH --output=log/eval/deepseek_r1_1.5b/hmmt25/think/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/deepseek_r1_1.5b/hmmt25/think"
