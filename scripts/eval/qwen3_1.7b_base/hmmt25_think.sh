#!/bin/bash
#SBATCH --job-name=eval_1p7bb_hmmt25_th
#SBATCH --output=log/eval/qwen3_1.7b_base/hmmt25/think/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/qwen3_1.7b_base/hmmt25/think"
