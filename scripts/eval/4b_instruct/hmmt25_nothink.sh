#!/bin/bash
#SBATCH --job-name=eval_4bi_hmmt25_nt
#SBATCH --output=log/eval/4b_instruct/hmmt25/nothink/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/4b_instruct/hmmt25/nothink"
