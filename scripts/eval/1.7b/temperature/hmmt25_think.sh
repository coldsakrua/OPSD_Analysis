#!/bin/bash
#SBATCH --job-name=eval_17b_t10_hmmt25_th
#SBATCH --output=log/eval/1.7b/temperature/hmmt25/think/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/1.7b/temperature/hmmt25/think"
