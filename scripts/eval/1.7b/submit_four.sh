#!/bin/bash
# Submit 4 think evals for Qwen3-1.7B (aime24/25/26 + hmmt25).
# Required: CHECKPOINT_PATH
# Optional: EVAL_TAG, BASE_DIR, JOB_PREFIX, SEED (default 42)
set -euo pipefail
