#!/bin/bash
#SBATCH --job-name=snt_tt_lora_clip005_lr5e6_1p7b_h25_nt
#SBATCH --output=log/eval/1.7b/lora/hmmt25/nothink/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/1.7b/lora/hmmt25/nothink"
