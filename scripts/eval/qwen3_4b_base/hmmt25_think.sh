#!/bin/bash
#SBATCH --job-name=eval_4bb_hmmt25_th
#SBATCH --output=log/eval/qwen3_4b_base/hmmt25/think/%x.%j.out
...
# Qwen3-4B-Base: https://www.modelscope.cn/models/Qwen/Qwen3-4B-Base
# Think-mode sampling aligned with scripts/eval/1.7b / qwen3_1.7b_base.
THINKING=1
DATASET=hmmt25
MODEL_TAG=qwen3_4b_base
DEFAULT_CKPT=/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-4b-base
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/qwen3_4b_base/hmmt25/think"
