#!/bin/bash
#SBATCH --job-name=st_tt_lora_clip005_lr5e6_q35_4b_h25_th
#SBATCH --output=log/eval/qwen3.5_4b/lora/hmmt25/think/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/qwen3.5_4b/lora/hmmt25/think"
