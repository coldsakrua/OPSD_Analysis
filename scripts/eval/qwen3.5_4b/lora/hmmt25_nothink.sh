#!/bin/bash
#SBATCH --job-name=snt_tt_lora_clip005_lr5e6_q35_4b_h25_nt
#SBATCH --output=log/eval/qwen3.5_4b/lora/hmmt25/nothink/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/qwen3.5_4b/lora/hmmt25/nothink"
