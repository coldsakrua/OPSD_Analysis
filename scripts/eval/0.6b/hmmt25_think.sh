#!/bin/bash
#SBATCH --job-name=eval_06b_hmmt25_th
#SBATCH --output=log/eval/0.6b/hmmt25/think/%x.%j.out
...
DATASET=hmmt25
MODEL_TAG=0.6b
DEFAULT_CKPT=/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-0.6b
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/0.6b/hmmt25/think"
