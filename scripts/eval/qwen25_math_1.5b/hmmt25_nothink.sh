#!/bin/bash
#SBATCH --job-name=eval_q25m15_h25
#SBATCH --output=log/eval/qwen25_math_1.5b/hmmt25/nothink/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/qwen25_math_1.5b/hmmt25/nothink"
