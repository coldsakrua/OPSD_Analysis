#!/bin/bash
#SBATCH --job-name=st_tt_lora_clip005_lr5e6_4b_h25_th
#SBATCH --output=log/eval/4b/lora/hmmt25/think/%x.%j.out
...
mkdir -p "$(dirname "${OUTPUT_JSON}")" "log/eval/4b/lora/hmmt25/think"
