#!/bin/bash
#SBATCH --job-name=da22dapo_a40_snt_tnt_olmo7bi
...
set -euo pipefail
# DAPO answer-only teacher_prefix (snt_tnt / olmo3_7b_instruct)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_dapo/olmo3_7b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
