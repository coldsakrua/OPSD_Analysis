#!/bin/bash
#SBATCH --job-name=da22dapo_a40_st_tt_mimo7b
...
set -euo pipefail
# DAPO answer-only teacher_prefix (st_tt / mimo_7b_rl)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_dapo/mimo_7b_rl/${RUN_SUFFIX}_${JOB_TAG}}
