...
#SBATCH --job-name=da26_snt_tnt_olmo7bi_easy
...
# 2.6 cotlen-easy snt_tnt on olmo3_7b_instruct
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/cotlen/olmo3_7b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
