#!/bin/bash
#SBATCH --job-name=da26_st_tt_1p7b_easy
...
# 2.6 cotlen-easy st_tt on qwen3_1.7b
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/cotlen/qwen3_1.7b/st_tt_easy_${JOB_TAG}}
