#!/bin/bash
#SBATCH --job-name=da26_snt_tnt_4bi_easy
...
# 2.6 cotlen-easy snt_tnt on qwen3_4b_instruct
# OT cotlen band=easy: prompt=2048 completion=32768; n=4 rollouts.
...
POOL=${POOL:-long}
RUN_SUFFIX="snt_tnt_easy"
if [[ "2.6" == "2.2" && "${POOL}" == "short" ]]; then
  RUN_SUFFIX="snt_tnt_easy_short"
fi
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/cotlen/qwen3_4b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
...
GEN_BATCH_HINT=${GEN_BATCH_HINT:-4}
