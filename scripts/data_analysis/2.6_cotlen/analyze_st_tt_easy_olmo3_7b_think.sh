...
#SBATCH --job-name=da26_st_tt_olmo7bt_easy
...
# 2.6 cotlen-easy st_tt on olmo3_7b_think
...
POOL=${POOL:-long}
RUN_SUFFIX="st_tt_easy"
if [[ "2.6" == "2.2" && "${POOL}" == "short" ]]; then
  RUN_SUFFIX="st_tt_easy_short"
fi
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/cotlen/olmo3_7b_think/${RUN_SUFFIX}_${JOB_TAG}}
