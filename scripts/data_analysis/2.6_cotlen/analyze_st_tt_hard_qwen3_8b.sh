#!/bin/bash
#SBATCH --job-name=da26_st_tt_8b_hard
...
# 2.6 cotlen-hard st_tt on qwen3_8b
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/cotlen/qwen3_8b/${RUN_SUFFIX}_${JOB_TAG}}
