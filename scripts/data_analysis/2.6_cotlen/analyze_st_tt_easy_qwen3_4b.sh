#!/bin/bash
#SBATCH --job-name=da26_st_tt_4b_easy
...
# 2.6 cotlen-easy st_tt on qwen3_4b
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/cotlen/qwen3_4b/${RUN_SUFFIX}_${JOB_TAG}}
