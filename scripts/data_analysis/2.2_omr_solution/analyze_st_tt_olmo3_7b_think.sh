...
#SBATCH --job-name=da22omr_st_tt_olmo7bt
...
# OMR full-solution teacher_prefix (st_tt / olmo3_7b_think)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr/olmo3_7b_think/${RUN_SUFFIX}_${JOB_TAG}}
