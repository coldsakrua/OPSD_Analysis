...
#SBATCH --job-name=da22omr_st_tt_falcon7b
...
# OMR full-solution teacher_prefix (st_tt / falcon_h1r_7b)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr/falcon_h1r_7b/${RUN_SUFFIX}_${JOB_TAG}}
