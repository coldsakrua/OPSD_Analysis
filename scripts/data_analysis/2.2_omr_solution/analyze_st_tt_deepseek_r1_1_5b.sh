#!/bin/bash
#SBATCH --job-name=da22omr_st_tt_ds1p5b
...
# OMR full-solution teacher_prefix (st_tt / deepseek_r1_1.5b)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr/deepseek_r1_1.5b/${RUN_SUFFIX}_${JOB_TAG}}
