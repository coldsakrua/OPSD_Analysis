#!/bin/bash
#SBATCH --job-name=da22omr_st_tt_4b
...
# OMR full-solution teacher_prefix (st_tt / qwen3_4b)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr/qwen3_4b/${RUN_SUFFIX}_${JOB_TAG}}
