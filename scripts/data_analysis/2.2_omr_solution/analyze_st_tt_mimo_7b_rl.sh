...
#SBATCH --job-name=da22omr_st_tt_mimo7b
...
# OMR full-solution teacher_prefix (st_tt / mimo_7b_rl)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr/mimo_7b_rl/${RUN_SUFFIX}_${JOB_TAG}}
