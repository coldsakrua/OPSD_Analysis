#!/bin/bash
#SBATCH --job-name=da22omr_st_tt_4bt
...
# OMR full-solution teacher_prefix (st_tt / qwen3_4b_thinking)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr/qwen3_4b_thinking/${RUN_SUFFIX}_${JOB_TAG}}
