...
#SBATCH --job-name=da22omr_snt_tnt_olmo7bi
...
# OMR full-solution teacher_prefix (snt_tnt / olmo3_7b_instruct)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr/olmo3_7b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
