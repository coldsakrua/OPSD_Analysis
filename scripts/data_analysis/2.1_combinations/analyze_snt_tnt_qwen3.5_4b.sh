...
#SBATCH --job-name=da21snttntqwen354b
#SBATCH --output=log/data_analysis/2.1_combinations/qwen3.5_4b/%x.%j.out
...
# 2.1 student/teacher combo snt_tnt on qwen3.5_4b
