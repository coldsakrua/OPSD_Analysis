#!/bin/bash
#SBATCH --job-name=da21_snt_tt_1p7b
...
# 2.1 combo snt_tt on qwen3_1.7b
...
if [[ "2.1" == "2.2" && "${POOL}" == "short" ]]; then
  RUN_SUFFIX="snt_tt_short"
fi
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/combinations/qwen3_1.7b/${RUN_SUFFIX}_${JOB_TAG}}
