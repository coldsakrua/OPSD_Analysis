#!/bin/bash
#SBATCH --job-name=da21_st_tt_4bt
...
# 2.1 combo st_tt on qwen3_4b_thinking
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/combinations/qwen3_4b_thinking/${RUN_SUFFIX}_${JOB_TAG}}
