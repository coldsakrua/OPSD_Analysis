...
#SBATCH --job-name=da21_st_tt_olmo7bt
...
# 2.1 combo st_tt on olmo3_7b_think
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/combinations/olmo3_7b_think/${RUN_SUFFIX}_${JOB_TAG}}
