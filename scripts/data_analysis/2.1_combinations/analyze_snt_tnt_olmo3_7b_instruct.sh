...
#SBATCH --job-name=da21_snt_tnt_olmo7bi
...
# 2.1 combo snt_tnt on olmo3_7b_instruct
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/combinations/olmo3_7b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
