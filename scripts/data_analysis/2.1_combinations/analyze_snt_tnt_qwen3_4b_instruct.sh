#!/bin/bash
#SBATCH --job-name=da21snttntqwen34binstruct
#SBATCH --output=log/data_analysis/2.1_combinations/qwen3_4b_instruct/%x.%j.out
...
# 2.1 student/teacher combo snt_tnt on qwen3_4b_instruct
