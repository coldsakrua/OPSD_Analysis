...
#SBATCH --job-name=da22_st_tt_olmo7bt
...
# 2.2 teacher prefix st_tt on olmo3_7b_think (sol/answer/irrelevant/sol_long@12288/cot_gold)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix/olmo3_7b_think/${RUN_SUFFIX}_${JOB_TAG}}
