...
#SBATCH --job-name=da22_snt_tnt_olmo7bi
...
# 2.2 teacher prefix snt_tnt on olmo3_7b_instruct (sol/answer/irrelevant/sol_long@12288/cot_gold)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix/olmo3_7b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
