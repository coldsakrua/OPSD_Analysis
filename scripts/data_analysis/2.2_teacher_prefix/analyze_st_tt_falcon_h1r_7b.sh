...
#SBATCH --job-name=da22_st_tt_falcon7b
...
# 2.2 teacher prefix st_tt on falcon_h1r_7b (sol/answer/irrelevant/sol_long@12288/cot_gold)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix/falcon_h1r_7b/${RUN_SUFFIX}_${JOB_TAG}}
