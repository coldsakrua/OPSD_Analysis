#!/bin/bash
#SBATCH --job-name=da22_st_tt_0p6b
...
# 2.2 teacher prefix st_tt on qwen3_06b (sol/answer/irrelevant/sol_long@12288/cot_gold)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix/qwen3_06b/${RUN_SUFFIX}_${JOB_TAG}}
