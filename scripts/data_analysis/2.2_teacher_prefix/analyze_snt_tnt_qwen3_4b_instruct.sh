#!/bin/bash
#SBATCH --job-name=da22snttntqwen34binstruct
#SBATCH --output=log/data_analysis/2.2_teacher_prefix/qwen3_4b_instruct/%x.%j.out
...
# 2.2 teacher prefix variants (sol/answer/irr) snt_tnt qwen3_4b_instruct
