...
#SBATCH --job-name=da22_st_tt_mimo7b
...
# 2.2 teacher prefix st_tt on mimo_7b_rl (sol/answer/irrelevant/sol_long@12288/cot_gold)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix/mimo_7b_rl/${RUN_SUFFIX}_${JOB_TAG}}
