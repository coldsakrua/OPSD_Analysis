#!/bin/bash
#SBATCH --job-name=da22_st_tt_ds1p5b
...
# 2.2 teacher prefix st_tt on deepseek_r1_1.5b (sol/answer/irrelevant/sol_long@12288/cot_gold)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix/deepseek_r1_1.5b/${RUN_SUFFIX}_${JOB_TAG}}

TASK="teacher_prefix"
MODEL_KEY="deepseek_r1_1.5b"
COMBO="st_tt"
MODEL_PATH="/gpfs/share/home/2501210611/labShare/2501210611/model/deepseek-r1-distill-qwen-1.5b"
CONDA_ENV="anchor"
BACKEND="vllm"
