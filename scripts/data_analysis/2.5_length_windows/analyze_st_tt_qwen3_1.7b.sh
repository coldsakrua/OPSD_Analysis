#!/bin/bash
#SBATCH --job-name=da25_st_tt_1p7b
...
# 2.5 length windows st_tt on qwen3_1.7b
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/length_windows/qwen3_1.7b/${RUN_SUFFIX}_${JOB_TAG}}
