#!/bin/bash
#SBATCH --job-name=da25_snt_tnt_4bi
...
# 2.5 length windows snt_tnt on qwen3_4b_instruct
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/length_windows/qwen3_4b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
...
GEN_BATCH_HINT=${GEN_BATCH_HINT:-16}
