...
#SBATCH --job-name=da25snttntolmo37binstruct
#SBATCH --output=log/data_analysis/2.5_length_windows/olmo3_7b_instruct/%x.%j.out
...
# 2.5 length-window analysis snt_tnt olmo3_7b_instruct
