#!/bin/bash
#SBATCH --job-name=da22dapo_snt_tnt_4bi
...
# DAPO answer-only teacher_prefix (snt_tnt / qwen3_4b_instruct)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_dapo/qwen3_4b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
