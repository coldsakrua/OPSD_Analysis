...
#SBATCH --job-name=da22dapo_st_tt_falcon7b
...
# DAPO answer-only teacher_prefix (st_tt / falcon_h1r_7b)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_dapo/falcon_h1r_7b/${RUN_SUFFIX}_${JOB_TAG}}
...
EXTRA_ARGS+=(--attention-backend triton --sampling-backend pytorch --mem-fraction-static 0.55)
