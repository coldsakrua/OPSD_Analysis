#!/bin/bash
#SBATCH --job-name=da22dapo_st_tt_4bt
...
# DAPO answer-only teacher_prefix (st_tt / qwen3_4b_thinking)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_dapo/qwen3_4b_thinking/${RUN_SUFFIX}_${JOB_TAG}}
