#!/bin/bash
#SBATCH --job-name=da22omrans_st_tt_1p7b
...
# OMR answer-only teacher_prefix (st_tt / qwen3_1.7b)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr_answer/qwen3_1.7b/${RUN_SUFFIX}_${JOB_TAG}}
