...
#SBATCH --job-name=da22omrans_st_tt_mimo7b
...
# OMR answer-only teacher_prefix (st_tt / mimo_7b_rl)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr_answer/mimo_7b_rl/${RUN_SUFFIX}_${JOB_TAG}}
...
TASK="teacher_prefix"
MODEL_KEY="mimo_7b_rl"
COMBO="st_tt"
MODEL_PATH="/gpfs/share/home/2501210611/labShare/2501210611/model/mimo-7b-rl"
CONDA_ENV="sglang"
BACKEND="sglang"
...
SCORE_BATCH=${SCORE_BATCH:-12}
GEN_BATCH_HINT=${GEN_BATCH_HINT:-128}
