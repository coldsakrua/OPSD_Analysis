#!/bin/bash
#SBATCH --job-name=da22omrans_snt_tnt_4bi
...
# OMR answer-only teacher_prefix (snt_tnt / qwen3_4b_instruct)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr_answer/qwen3_4b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
