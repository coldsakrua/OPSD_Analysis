#!/bin/bash
#SBATCH --job-name=da22omrans_st_tt_ds1p5b
...
# OMR answer-only teacher_prefix (st_tt / deepseek_r1_1.5b)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr_answer/deepseek_r1_1.5b/${RUN_SUFFIX}_${JOB_TAG}}
