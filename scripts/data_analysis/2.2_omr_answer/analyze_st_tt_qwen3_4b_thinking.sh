#!/bin/bash
#SBATCH --job-name=da22omrans_st_tt_4bt
...
# OMR answer-only teacher_prefix (st_tt / qwen3_4b_thinking)
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/teacher_prefix_omr_answer/qwen3_4b_thinking/${RUN_SUFFIX}_${JOB_TAG}}
...
TASK="teacher_prefix"
MODEL_KEY="qwen3_4b_thinking"
COMBO="st_tt"
MODEL_PATH="/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-4b-thinking"
CONDA_ENV="anchor"
BACKEND="vllm"
