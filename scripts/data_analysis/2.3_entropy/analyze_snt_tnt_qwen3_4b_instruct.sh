#!/bin/bash
#SBATCH --job-name=da23_snt_tnt_4bi
...
# 2.3 entropy (he20/le20/he80/le80) snt_tnt on qwen3_4b_instruct
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/entropy/qwen3_4b_instruct/${RUN_SUFFIX}_${JOB_TAG}}
