#!/bin/bash
#SBATCH --job-name=da23_st_tt_4bt
...
# 2.3 entropy (he20/le20/he80/le80) st_tt on qwen3_4b_thinking
...
POOL=${POOL:-long}
RUN_SUFFIX="st_tt"
if [[ "2.3" == "2.2" && "${POOL}" == "short" ]]; then
  RUN_SUFFIX="st_tt_short"
fi
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/entropy/qwen3_4b_thinking/${RUN_SUFFIX}_${JOB_TAG}}
