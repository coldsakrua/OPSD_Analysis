...
# 2.3 entropy (he20/le20/he80/le80) st_tt on qwen3_4b
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/entropy/qwen3_4b/${RUN_SUFFIX}_${JOB_TAG}}
