...
#SBATCH --job-name=da23_st_tt_olmo7bt
...
# 2.3 entropy (he20/le20/he80/le80) st_tt on olmo3_7b_think
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/entropy/olmo3_7b_think/${RUN_SUFFIX}_${JOB_TAG}}
