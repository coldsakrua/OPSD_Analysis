#!/bin/bash
#SBATCH --job-name=da23stttqwen34bthinkinghe80
#SBATCH --output=log/data_analysis/2.3_entropy/qwen3_4b_thinking/%x.%j.out
...
# 2.3 entropy bucket he80 st_tt qwen3_4b_thinking
