#!/bin/bash
#SBATCH --job-name=da23_st_tt_1p7b
...
# 2.3 entropy (he20/le20/he80/le80) st_tt on qwen3_1.7b
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/entropy/qwen3_1.7b/${RUN_SUFFIX}_${JOB_TAG}}
