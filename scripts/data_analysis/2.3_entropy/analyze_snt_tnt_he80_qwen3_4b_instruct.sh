#!/bin/bash
#SBATCH --job-name=da23snttntqwen34binstructhe80
#SBATCH --output=log/data_analysis/2.3_entropy/qwen3_4b_instruct/%x.%j.out
...
# 2.3 entropy bucket he80 snt_tnt qwen3_4b_instruct
