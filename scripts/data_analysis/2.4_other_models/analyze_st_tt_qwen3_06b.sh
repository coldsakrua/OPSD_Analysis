#!/bin/bash
#SBATCH --job-name=da24stttqwen306b
#SBATCH --output=log/data_analysis/2.4_other_models/qwen3_06b/%x.%j.out
...
# 2.4 additional model qwen3_06b st_tt
