...
#SBATCH --job-name=da24_st_tt_mimo7b
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/combinations/mimo_7b_rl/${RUN_SUFFIX}_${JOB_TAG}}
