#!/bin/bash
#SBATCH --job-name=da24_st_tt_ds1p5b
...
POOL=${POOL:-long}
RUN_SUFFIX="st_tt"
if [[ "2.4" == "2.2" && "${POOL}" == "short" ]]; then
  RUN_SUFFIX="st_tt_short"
fi
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/scripts/data_analysis/outputs/combinations/deepseek_r1_1.5b/${RUN_SUFFIX}_${JOB_TAG}}
