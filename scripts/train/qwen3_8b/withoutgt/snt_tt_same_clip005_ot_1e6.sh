#!/bin/bash
#SBATCH --job-name=snt_tt_same_clip005_8b
...
# Qwen3-8B snt_tt, no-GT: student/teacher share the same user prefix.
# - Student: problem prompt, enable_thinking=0
# - Teacher: identical user content, enable_thinking=1 (no solution/answer)
# Recipe otherwise matches snt_tt clip005: lr=1e-6, clip=0.05, 100 steps.
...
RUN_NAME=${RUN_NAME:-snt_tt_same_clip005_1e_6_openthoughts_8b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_8b_snt_tt_same_clip005}
