#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c256_8b
...
# 8B st_tt + jsd_token_clip=0.05: max_completion=256.
...
export RUN_NAME=st_tt_clip005_1e_6_ot_8b_c256
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_8b_st_tt_clip005_longgen_c256}
