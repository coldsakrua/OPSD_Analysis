#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_ot_cotlen_easy_8b
...
# Qwen3-8B OPSD on easy OpenThoughts (gold CoT length decile 0-4, short):
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_ot_cotlen_easy_8b}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-8b}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/openthoughts/preprocessed/openthoughts.cotlen_easy.opsd.solution.sthink_tthink.qwen3_8b.maxprompt2048.parquet}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_8b_fullparam_100step_ot_cotlen_easy_sttt}
