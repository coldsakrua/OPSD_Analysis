#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_8b_easy
...
# Qwen3-8B OPSD on easy MathNet (gold CoT length decile 0-4, short):
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_mn_easy_8b}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-8b}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/mathnet_text/preprocessed/mathnet_text.cotlen_easy.opsd.solution.sthink_tthink.qwen3_8b.maxprompt4096.parquet}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_8b_fullparam_100step_mn_cotlen_easy_sttt}
