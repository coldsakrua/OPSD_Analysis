#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_1e6_ota_c256
...
export RUN_NAME=snt_tnt_clip005_1e_6_openthoughts_answer_c256
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_8b_fullparam_100step_openthoughts_answer_c256}
...
bash /gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/qwen3_8b/jsd005/opsd_student_nothink_teacher_nothink_clip005_1e_6_openthoughts_answer.sh
