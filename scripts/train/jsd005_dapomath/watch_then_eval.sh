#!/bin/bash
# CPU-node watcher: when checkpoint-100 is complete, submit 4 think evals
# (aime24/25/26 + hmmt25). Does not wait for train to exit.
#
...
SUBMIT="${BASE_DIR}/scripts/train/jsd005_dapomath/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/jsd005_dapomath/watch_state"
LOG="${BASE_DIR}/log/train/jsd005_dapomath/watch.${SLURM_JOB_ID:-manual}.log"
