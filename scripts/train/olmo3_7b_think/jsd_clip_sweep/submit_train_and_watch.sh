#!/bin/bash
# Submit Olmo-3-7B-Think OPSD trains for jsd_token_clip=0.1 and 0.01,
# write manifest, then start a CPU-node watcher that submits ckpt-100 evals.
#
# Usage (from OPSD_Analysis):
#   bash scripts/train/olmo3_7b_think/jsd_clip_sweep/submit_train_and_watch.sh
set -euo pipefail
...
declare -a JOBS=(
  "olmo3_7b_think|olmo3_7b_think|st_tt_clip01_1e_6_openthoughts_olmo7bt|scripts/train/olmo3_7b_think/jsd01/opsd_student_think_teacher_think_clip01_1e_6_openthoughts.sh|st_tt_clip01_1e6_olmo7bt_ckpt100"
  "olmo3_7b_think|olmo3_7b_think|st_tt_clip001_1e_6_openthoughts_olmo7bt|scripts/train/olmo3_7b_think/jsd001/opsd_student_think_teacher_think_clip001_1e_6_openthoughts.sh|st_tt_clip001_1e6_olmo7bt_ckpt100"
)
