#!/bin/bash
# CPU-node watcher: when Olmo-3-7B-Think st_tt instruction train finishes
...
SUBMIT="${BASE_DIR}/scripts/train/olmo3_7b_think/instruction/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/olmo3_7b_think_instr/watch_state"
LOG="${BASE_DIR}/log/train/olmo3_7b_think_instr/watch.${SLURM_JOB_ID:-manual}.log"
