#!/bin/bash
#SBATCH --job-name=st_tt_clip001_1e6_olmo7bt
...
# Think-only model (no nothink mode). jsd_token_clip=0.01, lr=1e-6.
#   LR=1e-6, JSD_TOKEN_CLIP=0.01, micro=4, gas=4, 4 GPU → global_batch=64
...
RUN_NAME=${RUN_NAME:-st_tt_clip001_1e_6_openthoughts_olmo7bt}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-olmo3_7b_think_clip001_fullparam_100step_openthoughts}
