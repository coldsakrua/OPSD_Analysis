#!/bin/bash
#SBATCH --job-name=st_tt_clip005_topk16_rkl_olmo7bt
...
# Reverse top-k KL (k=16) for Olmo-3-7B-Think; rollout c1024; clip=0.05.
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_topk16_rkl_c1024_olmo7bt}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-olmo3_7b_think_topk16_rkl_openthoughts}
...
echo "[launch] lr=${LEARNING_RATE} beta=${BETA} jsd_token_clip=${JSD_TOKEN_CLIP} seed=${SEED} top_k_loss=16 (reverse)"
