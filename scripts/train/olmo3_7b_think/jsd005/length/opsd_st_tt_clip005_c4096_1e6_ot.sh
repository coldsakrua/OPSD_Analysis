#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c4096_olmo7bt
...
# Olmo-3-7B-Think st_tt + jsd_token_clip=0.05: max_completion=4096.
...
export RUN_NAME=st_tt_clip005_1e_6_ot_olmo7bt_c4096
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-olmo3_7bt_st_tt_clip005_longgen_c4096}
