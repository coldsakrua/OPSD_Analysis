#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c256_olmo7bt_le20
...
# Baseline (full-token c256): scripts/train/olmo3_7b_think/jsd005/length/opsd_st_tt_clip005_c256_1e6_ot.sh

# Olmo-3-7B-Think OPSD: student AND teacher both think; teacher gets full solution.
# Think-only model (no nothink mode). jsd_token_clip=0.05, lr=1e-6.
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c256_olmo7bt_le20}
