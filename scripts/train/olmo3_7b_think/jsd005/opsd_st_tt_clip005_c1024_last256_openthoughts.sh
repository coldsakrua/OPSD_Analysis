#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c1024_last256_olmo7bt
...
# c1024 + last256 variant (Olmo-3-7B-Think)
#   c1024: max_completion=1024
#   last256: --last-loss-tokens 256
...
LAST_LOSS_TOKENS=${LAST_LOSS_TOKENS:-256}
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c1024_last256_olmo7bt}
...
echo "[launch] lr=${LEARNING_RATE} jsd_token_clip=${JSD_TOKEN_CLIP} seed=${SEED} last_loss_tokens=${LAST_LOSS_TOKENS}"
