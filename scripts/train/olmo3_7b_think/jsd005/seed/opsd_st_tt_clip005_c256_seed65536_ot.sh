#!/bin/bash
#SBATCH --job-name=st_tt_c256_s65536_olmo
...
# Parent: scripts/train/olmo3_7b_think/jsd005/length/opsd_st_tt_clip005_c256_1e6_ot.sh
# Eval these ckpts with default SEED=42.
# variant=c256
export SEED=65536
export RUN_NAME=st_tt_clip005_c256_seed65536_olmo7bt
export BASE_DIR="${BASE_DIR:-${SLURM_SUBMIT_DIR:-/gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis}}"
bash "/gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/olmo3_7b_think/jsd005/length/opsd_st_tt_clip005_c256_1e6_ot.sh"
