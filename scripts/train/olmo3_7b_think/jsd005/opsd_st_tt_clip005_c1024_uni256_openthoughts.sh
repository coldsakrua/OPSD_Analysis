#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c1024_uni256_olmo7bt
...
# c1024 + uni256 variant (Olmo-3-7B-Think)
#   c1024: max_completion=1024
#   uni256: --uniform-loss-tokens 256
...
UNIFORM_LOSS_TOKENS=${UNIFORM_LOSS_TOKENS:-256}
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c1024_uni256_olmo7bt}
...
echo "[launch] lr=${LEARNING_RATE} jsd_token_clip=${JSD_TOKEN_CLIP} seed=${SEED} uni_loss_tokens=${UNIFORM_LOSS_TOKENS}"
