#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c1024_first256_olmo7bt
...
# c1024 + first256 variant (Olmo-3-7B-Think)
#   c1024: max_completion=1024
#   first256: --first-loss-tokens 256
...
FIRST_LOSS_TOKENS=${FIRST_LOSS_TOKENS:-256}
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c1024_first256_olmo7bt}
...
echo "[launch] lr=${LEARNING_RATE} jsd_token_clip=${JSD_TOKEN_CLIP} seed=${SEED} first_loss_tokens=${FIRST_LOSS_TOKENS}"
