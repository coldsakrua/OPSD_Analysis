#!/bin/bash
# CPU-node watcher: when Olmo-3-7B-Think OT cot+gold OPSD train finishes
...
SUBMIT="${BASE_DIR}/scripts/train/olmo3_7b_think/jsd005/submit_four_think_evals_ot_cot.sh"
STATE_DIR="${BASE_DIR}/log/train/olmo3_7b_think_ot_cot/watch_state"
LOG="${BASE_DIR}/log/train/olmo3_7b_think_ot_cot/watch.${SLURM_JOB_ID:-manual}.log"
