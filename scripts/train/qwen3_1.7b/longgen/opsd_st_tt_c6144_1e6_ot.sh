#!/bin/bash
#SBATCH --job-name=st_tt_c6144_1p7b
...
# 1.7B st_tt long-gen: max_completion=6144.
...
export RUN_NAME=st_tt_1e_6_ot_1p7b_c6144
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_st_tt_longgen_c6144}
