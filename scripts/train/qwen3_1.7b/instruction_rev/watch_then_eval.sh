#!/bin/bash
# CPU-node watcher: when Qwen3-1.7B st_tt instruction_rev train finishes
...
SUBMIT="${BASE_DIR}/scripts/train/qwen3_1.7b/instruction_rev/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/qwen3_1p7b_instrrev/watch_state"
LOG="${BASE_DIR}/log/train/qwen3_1p7b_instrrev/watch.${SLURM_JOB_ID:-manual}.log"
