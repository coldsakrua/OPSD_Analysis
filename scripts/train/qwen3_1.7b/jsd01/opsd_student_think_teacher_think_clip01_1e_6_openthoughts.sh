#!/bin/bash
#SBATCH --job-name=st_tt_clip01_1e6_1p7b
...
# jsd_token_clip=0.1 (official README / run_opsd_1b.sh). lr kept at 1e-6.
...
JSD_TOKEN_CLIP=${JSD_TOKEN_CLIP:-0.1}
SEED=${SEED:-42}
...
RUN_NAME=${RUN_NAME:-st_tt_clip01_1e_6_openthoughts_1p7b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_clip01_fullparam_100step_openthoughts}
