#!/bin/bash
# CPU-node watcher: when Qwen3-1.7B jsd clip 0.01 / 0.1 / 0.2 trains finish
...
SUBMIT="${BASE_DIR}/scripts/train/qwen3_1.7b/jsd_clip_sweep/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/qwen3_1p7b_jsd_clip/watch_state"
LOG="${BASE_DIR}/log/train/qwen3_1p7b_jsd_clip/watch.${SLURM_JOB_ID:-manual}.log"
