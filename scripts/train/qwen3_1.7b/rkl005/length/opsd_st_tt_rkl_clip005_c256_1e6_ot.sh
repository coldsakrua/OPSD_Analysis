#!/bin/bash
#SBATCH --job-name=st_tt_rkl_clip005_c256_1p7b
...
# qwen3_1.7b st_tt + reverse KL (beta=1.0) + clip=0.05: max_completion=256.
...
export RUN_NAME=st_tt_rkl_clip005_1e_6_ot_1p7b_c256
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_st_tt_rkl_clip005_longgen_c256}
...
bash /gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/qwen3_1.7b/rkl005/opsd_student_think_teacher_think_rkl_clip005_1e_6_openthoughts.sh
