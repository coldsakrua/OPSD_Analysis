#!/bin/bash
#SBATCH --job-name=snt_tnt_1e6_1p7b
...
# Qwen3-1.7B OPSD: student AND teacher both nothink, teacher gets full solution.
# jsd_token_clip=1e-6 matches official non-thinking scripts (run_opsd_*_nonthink.sh).
...
RUN_NAME=${RUN_NAME:-snt_tnt_1e_6_openthoughts_1p7b}
