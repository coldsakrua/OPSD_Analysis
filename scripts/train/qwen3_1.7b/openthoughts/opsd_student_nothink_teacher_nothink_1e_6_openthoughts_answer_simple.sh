#!/bin/bash
#SBATCH --job-name=snt_tnt_1e6_otas_1p7b
...
RUN_NAME=${RUN_NAME:-snt_tnt_1e_6_openthoughts_answer_simple_1p7b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_fullparam_100step_openthoughts_answer_simple}
