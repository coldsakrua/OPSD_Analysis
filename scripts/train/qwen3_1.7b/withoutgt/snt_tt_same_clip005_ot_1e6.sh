#!/bin/bash
#SBATCH --job-name=snt_tt_same_clip005_1p7b
...
# Qwen3-1.7B snt_tt, no-GT: student/teacher share the same user prefix.
...
RUN_NAME=${RUN_NAME:-snt_tt_same_clip005_1e_6_openthoughts_1p7b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_snt_tt_same_clip005}
