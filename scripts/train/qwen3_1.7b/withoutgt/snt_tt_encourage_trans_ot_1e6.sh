#!/bin/bash
#SBATCH --job-name=snt_tt_enc_tr_1p7b
...
# - Teacher: ENCOURAGE_PREFIX + Problem + transition, enable_thinking=1
...
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=snt_tt_encourage_trans_ot_1e_6_1p7b
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_withoutgt_encourage_trans}
