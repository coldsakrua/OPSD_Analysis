#!/bin/bash
# CPU-node watcher: when Qwen3-1.7B st_tt instruction train finishes
...
SUBMIT="${BASE_DIR}/scripts/train/qwen3_1.7b/instruction/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/qwen3_1p7b_instr/watch_state"
LOG="${BASE_DIR}/log/train/qwen3_1p7b_instr/watch.${SLURM_JOB_ID:-manual}.log"
