#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_ot_cotlen_easy_c256
...
# 1.7B st_tt OT cotlen-easy (D0-4) with max_completion=256.
...
export RUN_NAME=st_tt_clip005_1e_6_ot_cotlen_easy_1p7b_c256
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_fullparam_100step_ot_cotlen_easy_sttt_c256}
...
bash /gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/qwen3_1.7b/jsd005/st_tt_acc/opsd_student_think_teacher_think_clip005_1e_6_openthoughts_cotlen_easy.sh
