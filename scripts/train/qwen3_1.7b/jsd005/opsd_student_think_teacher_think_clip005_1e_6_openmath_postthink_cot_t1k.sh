#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_omr_ptcot1k
...
# Same 1k postthink rows; teacher privilege = think CoT + gold.
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_openmath_postthink_cot_t1k_1p7b}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-1.7b}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/openmathreasoning/preprocessed/omr.opsd.solution.postthink_cot.sthink_tthink.same_t1k.parquet}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_fullparam_100step_openmath_postthink_cot_t1k}
...
echo "[launch] same t1k rows; teacher=cot+gold cap=${MAX_PROMPT_LENGTH}"
