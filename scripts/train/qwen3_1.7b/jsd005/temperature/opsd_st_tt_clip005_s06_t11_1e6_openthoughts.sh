#!/bin/bash
#SBATCH --job-name=st_tt_clip005_s06t11_1p7b
...
# Qwen3-1.7B st_tt temperature ablation: student rollout/JSD temp=0.6, teacher JSD temp=1.1.
# Baseline (shared 1.1): ../opsd_student_think_teacher_think_clip005_1e_6_openthoughts.sh

STUDENT_TEMPERATURE=${STUDENT_TEMPERATURE:-0.6}
TEACHER_TEMPERATURE=${TEACHER_TEMPERATURE:-1.1}
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_s06_t11_1e6_openthoughts_1p7b}
