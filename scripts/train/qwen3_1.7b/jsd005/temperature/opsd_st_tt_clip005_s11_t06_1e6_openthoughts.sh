#!/bin/bash
#SBATCH --job-name=st_tt_clip005_s11t06_1p7b
...
# Qwen3-1.7B st_tt temperature ablation: student rollout/JSD temp=1.1, teacher JSD temp=0.6.

STUDENT_TEMPERATURE=${STUDENT_TEMPERATURE:-1.1}
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_s11_t06_1e6_openthoughts_1p7b}
