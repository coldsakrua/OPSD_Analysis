#!/bin/bash
#SBATCH --job-name=snt_tt_clip005_1e6_1p7b
...
# Qwen3-1.7B OPSD: student nothink + teacher think, teacher gets full solution.
# Same as opsd_student_nothink_teacher_think_1e_6_openthoughts.sh, but
...
RUN_NAME=${RUN_NAME:-snt_tt_clip005_1e_6_openthoughts_1p7b}
