#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_omr_pt1k
...
#   - teacher prefix <= 1024 (chat template included)
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_openmath_postthink_t1k_1p7b}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-1.7b}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/openmathreasoning/preprocessed/omr.opsd.solution.postthink.sthink_tthink.maxprompt1024.parquet}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_fullparam_100step_openmath_postthink_t1k}
...
echo "[launch] postthink teacher_cap=${MAX_PROMPT_LENGTH} (chat template included)"
