#!/bin/bash
# CPU-node watcher: when Qwen3-1.7B OT cot+gold t4096 OPSD train finishes
...
SUBMIT="${BASE_DIR}/scripts/train/qwen3_1.7b/jsd005/submit_four_think_evals_ot_cot_t4096.sh"
STATE_DIR="${BASE_DIR}/log/train/qwen3_1p7b_ot_cot_t4096/watch_state"
LOG="${BASE_DIR}/log/train/qwen3_1p7b_ot_cot_t4096/watch.${SLURM_JOB_ID:-manual}.log"
