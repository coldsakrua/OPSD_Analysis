#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_ota_1p7b
...
# st_tt counterpart of opsd_student_nothink_teacher_nothink_clip005_1e_6_openthoughts_answer.sh:
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_openthoughts_answer_1p7b}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-1.7b}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/openthoughts/preprocessed/openthoughts.correct.answer.sthink_tthink.maxprompt1024.parquet}
