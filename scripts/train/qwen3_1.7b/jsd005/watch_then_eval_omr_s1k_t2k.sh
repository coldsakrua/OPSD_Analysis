#!/bin/bash
# CPU-node watcher: when Qwen3-1.7B OMR s1k/t2k OPSD train finishes
...
SUBMIT="${BASE_DIR}/scripts/train/qwen3_1.7b/jsd005/submit_four_think_evals_omr_s1k_t2k.sh"
STATE_DIR="${BASE_DIR}/log/train/qwen3_1p7b_omr_s1k_t2k/watch_state"
LOG="${BASE_DIR}/log/train/qwen3_1p7b_omr_s1k_t2k/watch.${SLURM_JOB_ID:-manual}.log"
