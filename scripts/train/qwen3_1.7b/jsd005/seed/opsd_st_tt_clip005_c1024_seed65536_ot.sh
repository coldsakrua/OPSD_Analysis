#!/bin/bash
#SBATCH --job-name=st_tt_c1024_s65536_1p7b
...
# Parent: scripts/train/qwen3_1.7b/jsd005/opsd_student_think_teacher_think_clip005_1e_6_openthoughts.sh
# Eval these ckpts with default SEED=42.
# variant=c1024
export SEED=65536
export RUN_NAME=st_tt_clip005_c1024_seed65536_1p7b
