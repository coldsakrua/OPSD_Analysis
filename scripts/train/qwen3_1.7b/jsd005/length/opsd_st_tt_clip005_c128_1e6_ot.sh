#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c128_1p7b
...
# 1.7B st_tt + jsd_token_clip=0.05: max_completion=128.
...
export RUN_NAME=st_tt_clip005_1e_6_ot_1p7b_c128
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_st_tt_clip005_longgen_c128}
