#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_c6144_1p7b
...
# 1.7B snt_tnt long-gen + jsd_token_clip=0.05: max_completion=6144.
...
export RUN_NAME=snt_tnt_clip005_1e_6_ot_1p7b_c6144
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_1p7b_snt_tnt_clip005_longgen_c6144}
