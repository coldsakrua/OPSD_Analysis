#!/bin/bash
# Submit 4 think evals (aime24/25/26 + hmmt25) for one snt_tt_same train.
#
# Required:
#   MODEL_KEY=qwen3_1.7b|qwen3_4b|qwen3_8b
...
case "${MODEL_KEY}" in
  ...
  qwen3_4b|4b)
    ...
    ;;
  qwen3_8b|8b)
    SCRIPT_DIR="${BASE_DIR}/scripts/eval/8b"
    LOG_ROOT="log/eval/8b"
    ;;
  *)
