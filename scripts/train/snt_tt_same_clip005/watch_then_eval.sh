#!/bin/bash
# CPU compute-node watcher: as soon as checkpoint-100 is complete, submit
# 4 think evals (aime24/25/26 + hmmt25). Does not wait for train to exit.
#
...
SUBMIT="${BASE_DIR}/scripts/train/snt_tt_same_clip005/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/snt_tt_same_clip005/watch_state"
LOG="${BASE_DIR}/log/train/snt_tt_same_clip005/watch.${SLURM_JOB_ID:-manual}.log"
