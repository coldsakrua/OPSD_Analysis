#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c256_adv_t16_4bt
...
# c256 + adv_t16 variant of opsd_student_think_teacher_think_clip005_1e_6_openthoughts.sh
#   c256: max_completion=256
#   adv_t16: --pos-adv-teacher-topk 16 (advantage>0 ∧ sampled ∈ teacher top-16)
# Other hyperparameters match the baseline above.
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c256_adv_t16_4bt}
...
echo "[launch] lr=${LEARNING_RATE} jsd_token_clip=${JSD_TOKEN_CLIP} pos_adv_teacher_topk=16 (adv_t16)"
echo "[launch] variant=c256+adv_t16 max_completion=${MAX_COMPLETION_LENGTH:-256}"
...
accelerate launch \
  ...
  --pos-adv-teacher-topk 16 \
  "${THINK_ARGS[@]}"  # adv_t16: pos-adv + teacher top-16
