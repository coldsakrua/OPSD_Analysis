#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c256_4bt_he80
...
# No --exclude for this he80 c256 run.
set -euo pipefail

# c256 + he80 variant
# Script: opsd_st_tt_clip005_c256_he80_openthoughts.sh (st_tt, c256, he80)
#   c256: max_completion=256 (student rollout length cap)
#   he80: --high-entropy-ratio 0.8 (top-80% student-entropy tokens per completion in loss)
...
#   sbatch scripts/train/<model>/jsd005/opsd_st_tt_clip005_c256_he80_openthoughts.sh
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c256_4bt_he80}
...
echo "[launch] lr=${LEARNING_RATE} jsd_token_clip=${JSD_TOKEN_CLIP} high_entropy_ratio=0.8 (he80)"
echo "[launch] variant=c256+he80 max_completion=256 high_entropy_ratio=0.8"
...
accelerate launch \
  ...
  --high-entropy-ratio 0.8 \
  "${THINK_ARGS[@]}"  # he80: per-seq top-80% entropy tokens
