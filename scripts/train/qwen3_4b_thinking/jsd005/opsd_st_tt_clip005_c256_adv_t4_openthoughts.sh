#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c256_adv_t4_4bt
...
# c256 + adv_t4 variant of opsd_student_think_teacher_think_clip005_1e_6_openthoughts.sh
#   c256: max_completion=256
#   adv_t4: --pos-adv-teacher-topk 4 (advantage>0 ∧ sampled ∈ teacher top-4)
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c256_adv_t4_4bt}
...
echo "[launch] lr=${LEARNING_RATE} jsd_token_clip=${JSD_TOKEN_CLIP} pos_adv_teacher_topk=4 (adv_t4)"
echo "[launch] variant=c256+adv_t4 max_completion=${MAX_COMPLETION_LENGTH:-256}"
...
accelerate launch \
  ...
  --pos-adv-teacher-topk 4 \
  "${THINK_ARGS[@]}"  # adv_t4: pos-adv + teacher top-4
