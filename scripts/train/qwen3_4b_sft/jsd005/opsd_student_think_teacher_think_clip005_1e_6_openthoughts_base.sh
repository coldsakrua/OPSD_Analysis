#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_4bb
...
# Qwen3-4B-Base OPSD (st_tt): student think + teacher think, privilege=opsd/solution.
...
# Weights: qwen3-4b-base; chat template from qwen3-4b instruct (same as SFT pipeline).
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_openthoughts_4b_base}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_base_fullparam_100step_openthoughts}
