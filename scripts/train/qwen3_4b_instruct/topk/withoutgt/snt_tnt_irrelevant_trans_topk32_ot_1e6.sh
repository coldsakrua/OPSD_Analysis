#!/bin/bash
#SBATCH --job-name=snt_tnt_irrel_tk32
...
# Top-K=32 KL | No-GT irrelevant + official transition (instruct) | snt_tnt
MODE=irrelevant_trans
TEACHER_PRIVILEGE_FIELD=none
STUDENT_THINKING=0
TEACHER_THINKING=0
RUN_NAME=snt_tnt_irrelevant_trans_topk32_ot_1e_6_instruct
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_instruct_topk32_withoutgt_irrelevant_trans}
