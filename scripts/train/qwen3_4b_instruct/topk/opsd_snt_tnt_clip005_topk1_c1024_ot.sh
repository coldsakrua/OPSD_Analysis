#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_topk1_oti
...
# Top-k KL (k=1) for Qwen3-4B-Instruct (snt_tnt); rollout c1024; clip=0.05.
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_topk1_c1024_oti}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_instruct_topk1_openthoughts}
