#!/bin/bash
#SBATCH --job-name=snt_tnt_tk32_oti
...
# Top-K=32 KL | Instruct OPSD solution | snt_tnt
MODE=opsd
TEACHER_PRIVILEGE_FIELD=solution
STUDENT_THINKING=0
TEACHER_THINKING=0
RUN_NAME=snt_tnt_topk32_1e_6_openthoughts_instruct
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_instruct_topk32_openthoughts}
