#!/bin/bash
#SBATCH --job-name=snt_tnt_1e6_iosi
...
# - lr=1e-6, aligned with other 4b-instruct OpenThoughts runs
...
RUN_NAME=${RUN_NAME:-snt_tnt_1e_6_openthoughts_irr_other_sol_instruct}
