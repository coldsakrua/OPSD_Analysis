#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_1e6_oti_easy
...
# Qwen3-4B-Instruct OPSD on easy MathNet (gold CoT length decile 0-4, short):
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_1e_6_mn_easy_oti}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-4b-instruct}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/mathnet_text/preprocessed/mathnet_text.cotlen_easy.opsd.solution.nothink.qwen3_4b_instruct.maxprompt4096.parquet}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_instruct_fullparam_100step_mn_cotlen_easy}
