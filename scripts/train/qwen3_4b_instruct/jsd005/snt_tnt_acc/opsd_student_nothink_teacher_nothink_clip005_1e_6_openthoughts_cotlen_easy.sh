#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_1e6_ot_cotlen_easy_oti
...
# Qwen3-4B-Instruct OPSD on easy OpenThoughts (gold CoT length decile 0-4, short):
# - Student AND teacher both nothink; privilege=solution
# Same steps/batch as snt_tnt clip005 baseline:
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_1e_6_ot_cotlen_easy_oti}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-4b-instruct}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/openthoughts/preprocessed/openthoughts.cotlen_easy.opsd.solution.nothink.qwen3_4b_instruct.maxprompt2048.parquet}
: "${DATASET_PATH:?Set DATASET_PATH to the easy snt_tnt preprocessed parquet}"
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_instruct_fullparam_100step_ot_cotlen_easy}
