#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_c256_oti_he20
...
# c256 + he20 variant
# Script: opsd_snt_tnt_clip005_c256_he20_openthoughts.sh (snt_tnt, c256, he20)
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_c256_oti_he20}
