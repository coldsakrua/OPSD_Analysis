#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_1e6_iosi_c256
...
export RUN_NAME=snt_tnt_clip005_1e_6_openthoughts_irr_other_sol_instruct_c256
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_instruct_fullparam_100step_openthoughts_irr_other_sol_c256}
...
bash /gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/qwen3_4b_instruct/jsd005/opsd_student_nothink_teacher_nothink_clip005_1e_6_openthoughts_irrelevant_other_sol.sh
