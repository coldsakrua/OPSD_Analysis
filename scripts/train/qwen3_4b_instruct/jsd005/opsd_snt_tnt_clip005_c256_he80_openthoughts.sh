#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_c256_oti_he80
...
# c256 + he80 variant
# Script: opsd_snt_tnt_clip005_c256_he80_openthoughts.sh (snt_tnt, c256, he80)
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_c256_oti_he80}
