#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_c128_4bi
...
# 4B-Instruct snt_tnt + jsd_token_clip=0.05: max_completion=128.
...
export RUN_NAME=snt_tnt_clip005_1e_6_oti_c128
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4bi_snt_tnt_clip005_longgen_c128}
