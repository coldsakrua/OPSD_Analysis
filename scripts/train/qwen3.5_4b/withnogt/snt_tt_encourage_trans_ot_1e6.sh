#!/bin/bash
#SBATCH --job-name=snt_tt_enc_tr_q35_4b
...
# Qwen3.5-4B No-GT encourage + official OPSD transition prompt (no reference solution):
# - Student: plain problem prompt, enable_thinking=0
# - Teacher: ENCOURAGE_PREFIX + Problem + OFFICIAL_TRANSITION_PROMPT, enable_thinking=1
#
...
RUN_NAME=${RUN_NAME:-snt_tt_encourage_trans_ot_1e_6_q35_4b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen35_4b_withnogt_encourage_trans}
