#!/bin/bash
#SBATCH --job-name=st_tt_1e6_q35_4b
...
#SBATCH --mem=220G
#SBATCH --time=3:00:00
#SBATCH --exclude=gpua800n13,gpua800n21,gpua800n08,gpua800n09
set -euo pipefail

# Qwen3.5-4B OPSD: student AND teacher both think, teacher gets full solution.
# Train batch matches qwen3_4b_instruct (micro=4, gas=4 → gbs=32).
# Rollout sampling matches scripts/eval/qwen3.5_4b/*_think.sh
...
RUN_NAME=${RUN_NAME:-st_tt_1e_6_openthoughts_q35_4b}
