#!/bin/bash
#SBATCH --job-name=snt_tnt_1e6_q35_4b
...
# Qwen3.5-4B OPSD: student AND teacher both nothink, teacher gets full solution.
# Train batch matches qwen3_4b_instruct (micro=4, gas=4, 2 GPU → global_batch=32).
# Rollout sampling matches scripts/eval/qwen3.5_4b/*_nothink.sh
...
RUN_NAME=${RUN_NAME:-snt_tnt_1e_6_openthoughts_q35_4b}
