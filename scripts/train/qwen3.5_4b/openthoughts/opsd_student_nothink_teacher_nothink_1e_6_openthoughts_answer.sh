#!/bin/bash
#SBATCH --job-name=snt_tnt_1e6_ota_q35
...
# Hyperparams / rollout / SGLang settings match the solution-privilege sibling.
...
# Eval-aligned rollout sampling (qwen3.5 nothink)
...
RUN_NAME=${RUN_NAME:-snt_tnt_1e_6_openthoughts_answer_q35_4b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen35_4b_fullparam_100step_openthoughts_answer}
