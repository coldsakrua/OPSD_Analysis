#!/bin/bash
#SBATCH --job-name=snt_tt_lora_q35
...
# LoRA OPSD on Qwen3.5-4B, aligned with official siyan-zhao/OPSD run_opsd_1b.sh:
...
# scripts/eval/qwen3.5_4b/*_nothink.sh (student is nothink).
...
RUN_NAME=${RUN_NAME:-snt_tt_lora_clip005_lr5e6_openthoughts_q35_4b}
