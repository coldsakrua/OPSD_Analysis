#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_1e6_q35
...
# Qwen3.5-4B OPSD: student nothink + teacher nothink, privilege=opsd/solution.
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_1e_6_openthoughts_q35_4b}
