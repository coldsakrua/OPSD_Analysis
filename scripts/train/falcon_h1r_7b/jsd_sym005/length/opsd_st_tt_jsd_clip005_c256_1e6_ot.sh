#!/bin/bash
#SBATCH --job-name=st_tt_jsd_clip005_c256_falcon7b
...
# Falcon-H1R-7B st_tt + symmetric JSD (beta=0.5) + clip=0.05: max_completion=256.
...
export RUN_NAME=${RUN_NAME:-st_tt_jsd_clip005_1e_6_ot_falcon7b_c256}
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-falcon_h1r_7b_st_tt_jsd_clip005_longgen_c256}
...
bash /gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/falcon_h1r_7b/jsd_sym005/opsd_student_think_teacher_think_jsd_clip005_1e_6_openthoughts.sh
