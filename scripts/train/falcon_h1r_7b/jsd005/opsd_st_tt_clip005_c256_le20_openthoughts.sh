#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c256_falcon7b_le20
...
# Baseline (full-token c256): scripts/train/falcon_h1r_7b/jsd005/length/opsd_st_tt_clip005_c256_1e6_ot.sh
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c256_falcon7b_le20}
