#!/bin/bash
#SBATCH --job-name=s1p7_t4bt_st_tt_clip005_1e6
...
# Cross-model OPSD (jsd_token_clip=0.05, lr=1e-6):
...
# Hyperparams match s1p7_t4b / qwen3_1.7b st_tt: micro=8, gas=4, 2 GPU → gbs=64.
#
# Env-overridable:
...
RUN_NAME=${RUN_NAME:-s1p7_t4bt_st_tt_clip005_1e_6_openthoughts}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-s1p7_t4bt_st_tt_clip005_openthoughts}
