#!/bin/bash
#SBATCH --job-name=snt_tt_1e6_4b_acc70
...
#SBATCH --exclude=gpua800n13,gpua800n10
set -euo pipefail

# OPSD on Qwen3-4B, high-acc OpenThoughts subset (base model n=8, acc>=0.70):
...
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=snt_tt_1e_6_ot_acc70_4b
LEARNING_RATE=1e-6

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-4b}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/openthoughts/preprocessed/openthoughts.qwen3_4b.nothink.n8.acc_70_100.opsd.solution.snothink_tthink.maxprompt1024.parquet}
