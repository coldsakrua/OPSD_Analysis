...
# OpenThoughts counterpart of scripts/train/dapo/opsd_nothink_4b.sh
MODE=correct
THINKING=0
TEACHER_PRIVILEGE_FIELD=answer
RUN_NAME=opsd_nothink_4b_ot
...
echo "[launch] run=${RUN_NAME_WITH_JOB} mode=${MODE} thinking=${THINKING} privilege_field=${TEACHER_PRIVILEGE_FIELD}"
