...
#SBATCH --exclude=gpua800n06,gpua800n07,gpua800n09,gpua800n11,gpua800n12,gpua800n13,gpua800n16
set -euo pipefail

# Same as opsd_student_nothink_teacher_think_4b.sh but lr=1e-6 and distinct run name.
MODE=correct
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=snt_tt_1e_6
LEARNING_RATE=1e-6
...
echo "[launch] run=${RUN_NAME_WITH_JOB} mode=${MODE} student_thinking=${STUDENT_THINKING} teacher_thinking=${TEACHER_THINKING} lr=${LEARNING_RATE}"
