#!/bin/bash
#SBATCH --job-name=snt_tt_same_t_tk16
...
# Top-K=16 KL | No-GT same + OFFICIAL_TRANSITION_PROMPT | snt_tt
MODE=same_trans
TEACHER_PRIVILEGE_FIELD=none
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=snt_tt_same_trans_topk16_ot_1e_6
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_topk16_withoutgt_same_trans}
