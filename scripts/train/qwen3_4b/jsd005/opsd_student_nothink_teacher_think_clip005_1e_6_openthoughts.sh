#!/bin/bash
#SBATCH --job-name=snt_tt_clip005_1e6_4b
...
# Qwen3-4B OPSD: student nothink + teacher think, privilege=opsd/solution.
...
RUN_NAME=${RUN_NAME:-snt_tt_clip005_1e_6_openthoughts_4b}
