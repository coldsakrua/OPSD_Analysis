#!/bin/bash
#SBATCH --job-name=st_tt_maskR_4b
...
# Qwen3-4B st_tt OPSD + mask reasoning family (same word list as 1.7b think runs).
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_openthoughts_4b_mask_reasoning}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_mask_reasoning_openthoughts}
...
echo "[launch] mode=${MODE} st_tt think lr=${LEARNING_RATE} jsd_token_clip=${JSD_TOKEN_CLIP}"
