#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_ota
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_openthoughts_answer}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_fullparam_100step_openthoughts_answer}
