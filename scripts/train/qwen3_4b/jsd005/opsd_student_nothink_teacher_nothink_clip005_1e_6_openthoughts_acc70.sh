#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_1e6_4b_acc70
...
# Same as opsd_student_nothink_teacher_nothink_1e_6_openthoughts_acc70.sh, but
# jsd_token_clip=0.05 (official README / run_opsd_1b.sh). lr kept at 1e-6.
# Qwen3-4B OPSD on high-acc OpenThoughts (base n=8, acc>=0.70).
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_1e_6_ot_acc70_4b}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-4b}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/openthoughts/preprocessed/openthoughts.qwen3_4b.nothink.n8.acc_70_100.opsd.solution.nothink.maxprompt1024.parquet}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_fullparam_100step_ot_acc70}
