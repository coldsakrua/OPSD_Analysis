#!/bin/bash
#SBATCH --job-name=st_tt_clip005_1e6_omr_sol_4b
...
# Qwen3-4B OPSD: gold solution (postthink / no CoT).
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_1e_6_omr_solution_postthink_50step_4b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_fullparam_50step_omr_solution_postthink}
