#!/bin/bash
#SBATCH --job-name=st_tt_clip005_c256_4b_le20
...
# Baseline (full-token c256): scripts/train/qwen3_4b/jsd005/length/opsd_st_tt_clip005_c256_1e6_ot.sh

# Qwen3-4B OPSD: student think + teacher think, privilege=opsd/solution.
...
RUN_NAME=${RUN_NAME:-st_tt_clip005_c256_4b_le20}
