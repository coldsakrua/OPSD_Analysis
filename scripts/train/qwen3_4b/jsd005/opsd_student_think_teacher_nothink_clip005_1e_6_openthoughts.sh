#!/bin/bash
#SBATCH --job-name=st_tnt_clip005_1e6_4b
...
# Qwen3-4B OPSD: student think + teacher nothink, privilege=opsd/solution.
...
RUN_NAME=${RUN_NAME:-st_tnt_clip005_1e_6_openthoughts_4b}
