#!/bin/bash
#SBATCH --job-name=s4b_tit_opsd_nogt_1e6
...
#SBATCH --exclude=gpua800n21
set -euo pipefail

# Cross-model no-GT control vs opsd_student_4b_nothink_teacher_instruct_1e6_openthoughts.sh:
...
STUDENT_THINKING=0
TEACHER_THINKING=0
RUN_NAME=s4b_tit_opsd_nogt_1e_6
LEARNING_RATE=1e-6
