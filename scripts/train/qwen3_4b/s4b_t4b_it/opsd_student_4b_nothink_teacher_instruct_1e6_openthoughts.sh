#!/bin/bash
#SBATCH --job-name=s4b_tit_opsd_1e6
...
# Cross-model OPSD (mirror of sit_tbt, roles reversed):
...
# - Student prompt: official unprivileged problem template
MODE=opsd
TEACHER_PRIVILEGE_FIELD=solution
STUDENT_THINKING=0
TEACHER_THINKING=0
RUN_NAME=s4b_tit_opsd_sol_1e_6
LEARNING_RATE=1e-6
