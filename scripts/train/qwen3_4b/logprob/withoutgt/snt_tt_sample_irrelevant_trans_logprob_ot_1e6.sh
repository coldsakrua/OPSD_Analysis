#!/bin/bash
#SBATCH --job-name=snt_tt_sample_lp
...
# Logprob-diff PG loss | No-GT sampled irrelevant + transition | snt_tt
MODE=sample_irrelevant_trans
TEACHER_PRIVILEGE_FIELD=none
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=snt_tt_sample_irrelevant_trans_logprob_ot_1e_6
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_logprob_withoutgt_sample_irrelevant_trans}
