#!/bin/bash
#SBATCH --job-name=snt_tt_same_clip005_4b
...
# Qwen3-4B snt_tt, no-GT: student/teacher share the same user prefix.
...
RUN_NAME=${RUN_NAME:-snt_tt_same_clip005_1e_6_openthoughts_4b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_snt_tt_same_clip005}
