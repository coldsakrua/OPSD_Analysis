#!/bin/bash
#SBATCH --job-name=snt_tnt_irr_tr
...
# No-GT irrelevant + OFFICIAL_TRANSITION_PROMPT (no reference solution):
# - Student: problem prompt, enable_thinking=0
# - Teacher: IRRELEVANT_PREFIX + Problem + transition, enable_thinking=0
MODE=irrelevant_trans
TEACHER_PRIVILEGE_FIELD=none
STUDENT_THINKING=0
TEACHER_THINKING=0
RUN_NAME=snt_tnt_irrelevant_trans_ot_1e_6
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_withoutgt_irrelevant_trans_snt_tnt}
