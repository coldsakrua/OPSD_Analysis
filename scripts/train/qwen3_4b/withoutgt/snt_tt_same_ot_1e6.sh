...
# No-GT baseline: student / teacher share the same user prompt.
# - Student: official chat template + problem, enable_thinking=0
# - Teacher: identical user content, enable_thinking=1
# Dataset: OpenThoughts (problem only; no answer/solution injected).
MODE=same
TEACHER_PRIVILEGE_FIELD=none
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=snt_tt_same_ot_1e_6
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_withoutgt_same}
