#!/bin/bash
#SBATCH --job-name=snt_tnt_enc_tr
...
# No-GT encourage + OFFICIAL_TRANSITION_PROMPT (no reference solution):
# - Student: problem prompt, enable_thinking=0
# - Teacher: ENCOURAGE_PREFIX + Problem + transition, enable_thinking=0
MODE=encourage_trans
TEACHER_PRIVILEGE_FIELD=none
STUDENT_THINKING=0
TEACHER_THINKING=0
RUN_NAME=snt_tnt_encourage_trans_ot_1e_6
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_withoutgt_encourage_trans_snt_tnt}
