...
# No-GT encourage prefix:
# - Student: official chat template + problem, enable_thinking=0
# - Teacher: English encouragement (no solution/answer) + same student user content, think=1
MODE=encourage
TEACHER_PRIVILEGE_FIELD=none
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=snt_tt_encourage_ot_1e_6
LEARNING_RATE=1e-6
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-qwen3_4b_withoutgt_encourage}
