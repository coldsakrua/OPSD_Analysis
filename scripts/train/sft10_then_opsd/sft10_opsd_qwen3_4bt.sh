...
# Pipeline: CE-SFT 10 steps (OMR long CoT) → OPSD 100 steps (OT maxprompt1024).
# SFT uses OMR parquet (not qwen-1.7b .tok) so 4B-Thinking chat template applies.
# OPSD: MODE=same, no teacher privilege; gbs=32.
...
SFT_RUN_NAME=${SFT_RUN_NAME:-sft_think_10step_omr12k_4bt}
...
OPSD_RUN_NAME=${OPSD_RUN_NAME:-st_tt_same_clip005_1e_6_ot1024_4bt_sft10omr}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP_SFT:-qwen3_4bt_sft10_omr12k}
