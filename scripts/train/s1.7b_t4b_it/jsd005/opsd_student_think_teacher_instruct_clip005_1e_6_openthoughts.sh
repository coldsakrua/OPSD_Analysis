#!/bin/bash
#SBATCH --job-name=s1p7_t4bit_opsd_clip005
...
# Cross-model OPSD vs qwen3_1.7b jsd005 st_tt clip005:
...
# Hyperparams match 1.7b st_tt: clip=0.05, lr=1e-6, micro=8, gas=4, 2 GPU → gbs=64.
#
# Env-overridable:
...
RUN_NAME=${RUN_NAME:-s1p7_t4bit_st_tnt_clip005_1e_6_openthoughts}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-s1p7_t4bit_st_tnt_clip005_openthoughts}
