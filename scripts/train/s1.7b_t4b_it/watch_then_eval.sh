#!/bin/bash
# CPU-node watcher: when s1.7b_t4b_it trains finish checkpoint-100,
# submit 4 think evals (SEED=42).
#
...
SUBMIT="${BASE_DIR}/scripts/train/s1.7b_t4b_it/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/s1.7b_t4b_it/watch_state"
LOG="${BASE_DIR}/log/train/s1.7b_t4b_it/watch.${SLURM_JOB_ID:-manual}.log"
