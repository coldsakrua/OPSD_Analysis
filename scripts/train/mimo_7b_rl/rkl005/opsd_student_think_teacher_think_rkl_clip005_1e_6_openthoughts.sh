#!/bin/bash
#SBATCH --job-name=st_tt_rkl_clip005_1e6_mimo7b
...
# Xiaomi MiMo-7B-RL OPSD reverse KL ablation:
...
# Batch: micro=2, gas=4, 4 GPU → global_batch=32 (same samples/update as jsd005 baseline).
#
# Env-overridable:
...
RUN_NAME=${RUN_NAME:-st_tt_rkl_clip005_1e_6_openthoughts_mimo7b}
