#!/bin/bash
#SBATCH --job-name=st_tt_rkl_clip005_c256_mimo7b
...
# MiMo-7B-RL st_tt + reverse KL (beta=1.0) + clip=0.05: max_completion=256.
...
export RUN_NAME=${RUN_NAME:-st_tt_rkl_clip005_1e_6_ot_mimo7b_c256}
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-mimo_7b_rl_st_tt_rkl_clip005_longgen_c256}
...
bash /gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/mimo_7b_rl/rkl005/opsd_student_think_teacher_think_rkl_clip005_1e_6_openthoughts.sh
