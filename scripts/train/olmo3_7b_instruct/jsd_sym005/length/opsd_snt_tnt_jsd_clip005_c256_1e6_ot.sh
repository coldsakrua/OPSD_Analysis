#!/bin/bash
#SBATCH --job-name=snt_tnt_jsd_clip005_c256_olmo7bi
...
# olmo3_7b_instruct snt_tnt + symmetric JSD (beta=0.5) + clip=0.05: max_completion=256.
...
export RUN_NAME=snt_tnt_jsd_clip005_1e_6_ot_olmo7bi_c256
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-olmo3_7bi_snt_tnt_jsd_clip005_longgen_c256}
...
bash /gpfs/share/home/2501210611/opsd_analysis/OPSD_Analysis/scripts/train/olmo3_7b_instruct/jsd_sym005/opsd_student_nothink_teacher_nothink_jsd_clip005_1e_6_openthoughts.sh
