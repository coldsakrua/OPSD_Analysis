#!/bin/bash
#SBATCH --job-name=snt_tnt_jsd_clip005_1e6_olmo7bi
...
# olmo3_7b_instruct OPSD symmetric JSD ablation:
...
RUN_NAME=${RUN_NAME:-snt_tnt_jsd_clip005_1e_6_openthoughts_olmo7bi}
