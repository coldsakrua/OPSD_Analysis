#!/bin/bash
#SBATCH --job-name=snt_tnt_clip005_1e6_olmo7bi_hard
...
# Olmo-3-7B-Instruct OPSD on hard MathNet (gold CoT length decile 8-9, long).
...
RUN_NAME=${RUN_NAME:-snt_tnt_clip005_1e_6_mn_hard_olmo7bit}

BASE_DIR=${BASE_DIR:-${SLURM_SUBMIT_DIR:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../../.." && pwd)}}
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/olmo3-7b-it}
DATASET_PATH=${DATASET_PATH:-${BASE_DIR}/data/mathnet_text/preprocessed/mathnet_text.cotlen_hard.opsd.solution.nothink.olmo3_7b_instruct.maxprompt4096.parquet}
: "${DATASET_PATH:?Set DATASET_PATH to the hard MathNet preprocessed parquet}"
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-olmo3_7b_instruct_fullparam_100step_mn_cotlen_hard}
...
echo "[launch] band=hard (MathNet gold CoT decile 8-9, long) thinking=off"
