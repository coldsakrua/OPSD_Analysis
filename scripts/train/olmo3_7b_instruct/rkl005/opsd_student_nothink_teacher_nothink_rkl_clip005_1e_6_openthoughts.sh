#!/bin/bash
#SBATCH --job-name=snt_tnt_rkl_clip005_1e6_olmo7bi
...
# olmo3_7b_instruct OPSD reverse KL ablation:
# Same as jsd005 default snt_tnt script, but
...
RUN_NAME=${RUN_NAME:-snt_tnt_rkl_clip005_1e_6_openthoughts_olmo7bi}
...
mkdir -p "${OUTPUT_DIR}" "${WANDB_DIR}" "${HF_HOME}" "${BASE_DIR}/log/train/olmo3-7b-instruct"
