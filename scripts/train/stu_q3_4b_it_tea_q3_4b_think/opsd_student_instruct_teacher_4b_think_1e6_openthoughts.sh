#!/bin/bash
#SBATCH --job-name=sit_tbt_opsd_1e6
...
STUDENT_THINKING=0
TEACHER_THINKING=1
RUN_NAME=sit_tbt_opsd_sol_1e_6
LEARNING_RATE=1e-6
...
# Prefer unfiltered dual parquet so online length filter uses Instruct student + 4b teacher templates.
