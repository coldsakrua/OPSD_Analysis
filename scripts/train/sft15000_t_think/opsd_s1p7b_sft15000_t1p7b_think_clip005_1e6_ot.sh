#!/bin/bash
#SBATCH --job-name=s1p7sft15k_t1p7t
...
# qwen3_1.7b/jsd005/opsd_student_think_teacher_think_clip005_1e_6_openthoughts.sh:
#   micro=8, gas=4, 2 GPU → gbs=64, max_steps=100.
# Student: Qwen3-1.7B-Base SFT last step (checkpoint-15000), enable_thinking=1
# Teacher: Qwen3-1.7B think mode (frozen), enable_thinking=1
...
RUN_NAME=${RUN_NAME:-s1p7b_sft15000_t1p7b_think_clip005_1e_6_ot}
...
TEACHER_MODEL_PATH=${TEACHER_MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/qwen3-1.7b}
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-sft15000_t_think_1p7b}
