#!/bin/bash
# Compute-node watcher: when SFT@15000 → think-teacher OPSD trains finish
...
SUBMIT="${BASE_DIR}/scripts/train/sft15000_t_think/submit_four_think_evals.sh"
STATE_DIR="${BASE_DIR}/log/train/sft15000_t_think/watch_state"
LOG="${BASE_DIR}/log/train/sft15000_t_think/watch.${SLURM_JOB_ID:-manual}.log"
