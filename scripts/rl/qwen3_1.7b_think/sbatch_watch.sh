#!/bin/bash
#SBATCH --job-name=watch_grpo_1p7
#SBATCH --output=log/train/rl/qwen3_1.7b_think/watch_slurm.%j.out
...
# CPU compute-node watcher for GRPO 1.7B: poll train → merge FSDP → 4 think evals.
